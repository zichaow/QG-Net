...
def preprocess_opts(parser):
    ...
    group.add_argument('-src_vocab_size', type=int, default=100000,
...
def generate_opts(parser):
    ...
    group.add_argument('-selection_criterion', default='NLL',
                       help='selection criterion after beam search output. Options: [NLL][NLL-QA]')
    group.add_argument('-debug', action='store_true',
                       help='output log files for debugging purposes.')
    group.add_argument('-saliency_vis', default=False,
                       help='output videos for visualization.')
    group.add_argument('-attn_vis', action='store_true',
                       help='output attention matrix images for visualization.')

    group.add_argument('-model', default='', # required
    ...
    group.add_argument('-src', default='', # required
...
def DrQA_opts(parser):
    # parser.add_argument('dataset', type=str, default=None,
    #                     help='SQuAD-like dataset to evaluate on')
    parser.add_argument('-DrQA_model', type=str,
    ...
    parser.add_argument('-tokenizer', type=str, default='corenlp',
                        help=("String option specifying tokenizer type to use "
                              "(e.g. 'corenlp')"))
    parser.add_argument('-corenlp_path', type=str,
                        help='path to corenlp')
...
class MarkdownHelpFormatter(argparse.HelpFormatter):
    ...
    This will translate something like:
    usage
    # **section heading**:
    ## **--argument-one**
    ```
